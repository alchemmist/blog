...
date: '2026-02-07T21:25:00+03:00'
language: ru
description: Это краткое руководство для начинающих, о том, как работать с открытым
  исходным кодом. Здесь вы можете найти классический способ внести свой вклад почти
  в любой проект. А так же узнать несколько советов и хаков.
tags:
- open-source
extra:
  custom_props:
...
> В каждом проекте есть свои собственные устояшиеся правила того,
> как нужн в них участвовать. Эти правило описываются либо
> в `README.md` в отдельном парагрфе "Contribution", либо
...
> Следует увожать те традиции, которые сложились в репозитории,
